This is the frontend part of aDisney Movie Prince N Princess project web application built using React.js. It provides the user interface for interacting with the application's features.
